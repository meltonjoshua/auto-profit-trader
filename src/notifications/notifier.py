...
class Notifier:
    ...
    async def send_trade_alert(self, symbol: str, side: str, amount: float, price: float, profit: float):
...
Keep up the great work! 🚀
    ...
    async def send_system_alert(self, alert_type: str, details: str, level: str = "info"):
