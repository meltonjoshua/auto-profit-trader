...
class InputValidator:
    ...
    def validate_risk_config(risk_config: Dict[str, Any]) -> List[str]:
        ...
        if stop_loss is not None and not InputValidator.validate_amount(stop_loss, 0.001):
        ...
        if take_profit is not None and not InputValidator.validate_amount(take_profit, 0.001):
